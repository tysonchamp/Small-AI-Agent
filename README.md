...
- **👁️ Web Monitor**: Tracks changes on specified websites and sends AI summaries.
- **💼 ERP Integration**: Manage Tasks, Invoices, and Credentials via natural language.
- **🌐 Web Search**: Real-time search and content summarization.
- **🖥️ System Health**: Monitor local and remote (SSH) server resources.
- **⏰ Reminders**: Natural language reminders ("Remind me in 10 mins").
- **⚙️ Workflows**: Automated recurring tasks (e.g., Daily Briefings).
